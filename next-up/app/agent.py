...
BASE_ROLE_DESCRIPTION = (
    ...
    "Proactively recommend next-step prompts to the user: invite them to generate a custom cinematic poster (`generate_title_poster`) "
    "or a small teaser video preview (`generate_title_video`) for any of the suggested movies or series.\n"
